...
A high-fidelity, Android-based enterprise task management application designed with a modern **Glassmorphism UI**. It features strict **multi-tenant** isolation, **hierarchical roles**, **advanced deadline rescheduling audits**, and **automated intelligent notifications using Firebase Cloud Functions**.
...
```text
app/
├── src/main/java/com/ssl/smarttaskreminder/
│   ├── data/          # Firestore Repositories & Data Models
│   ├── notifications/ # FCM Services, Widget Providers, Alarm Receivers
│   ├── ui/            # Glassmorphism Activities & Adapters (Role-based)
│   ├── utils/         # PDF Generators, Constants, Session Management
│   └── viewmodel/     # MVVM ViewModels linking UI to Repositories
└── functions/         # Node.js Firebase Cloud Functions (Triggers)
...
Designed, Developed & Maintained by **Prottoy Saha** for **Sonia Group** as an internal enterprise solution for advanced task tracking and productivity monitoring.
